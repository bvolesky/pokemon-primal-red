const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_KADABRA]    = {{EVO_LEVEL, 36, SPECIES_ALAKAZAM}},  // Trade → Level 36
    [SPECIES_MACHOP]     = {{EVO_LEVEL, 28, SPECIES_MACHOKE}},
    [SPECIES_MACHOKE]    = {{EVO_LEVEL, 36, SPECIES_MACHAMP}},  // Trade → Level 36
    ...
    [SPECIES_GRAVELER]   = {{EVO_LEVEL, 36, SPECIES_GOLEM}},  // Trade → Level 36
    ...
    [SPECIES_HAUNTER]    = {{EVO_LEVEL, 36, SPECIES_GENGAR}},  // Trade → Level 36
    ...
    [SPECIES_SCYTHER]    = {{EVO_LEVEL, 40, SPECIES_SCYTHER}},  // No Scizor
