...
static const struct TrainerMonNoItemCustomMoves sParty_BugCatcherDoug[] = {
    ...
    },
    {
        ...
        .lvl = 8,
        .species = SPECIES_CATERPIE,
        .moves = {MOVE_TACKLE, MOVE_STRING_SHOT, MOVE_SNORE, MOVE_NONE}, // SNORE adds flavor if you're using Sleep mechanics early
    },
    {
        .iv = 20,
        .lvl = 8,
        .species = SPECIES_METAPOD,
        .moves = {MOVE_HARDEN, MOVE_TACKLE, MOVE_STRING_SHOT, MOVE_NONE}, // Now has utility and some offense
    },
};
...
static const struct TrainerMonNoItemCustomMoves sParty_BugCatcherSammy[] = {
    {
        ...
        .moves = {MOVE_TWINEEDLE, MOVE_FOCUS_ENERGY, MOVE_STRING_SHOT, MOVE_NONE},
    },
    {
        .iv = 31,
        .lvl = 10,
        .species = SPECIES_BUTTERFREE,
        .moves = {MOVE_CONFUSION, MOVE_SLEEP_POWDER, MOVE_GUST, MOVE_NONE},
    },
    {
        .iv = 31,
        .lvl = 9,
        .species = SPECIES_VENONAT,
        .moves = {MOVE_CONFUSION, MOVE_POISON_POWDER, MOVE_SUPERSONIC, MOVE_NONE},
    },
    {
        .iv = 31,
        .lvl = 9,
        .species = SPECIES_PARAS,
        .moves = {MOVE_SCRATCH, MOVE_SPORE, MOVE_ABSORB, MOVE_NONE},
    },
};
...
static const struct TrainerMonNoItemCustomMoves sParty_CamperLiam[] = {
    {
        ...
        .moves = {MOVE_ROCK_THROW, MOVE_MUD_SLAP, MOVE_DEFENSE_CURL, MOVE_TACKLE},
    },
    {
        .iv = 24,
        .lvl = 11,
        .species = SPECIES_SANDSHREW,
        .moves = {MOVE_SCRATCH, MOVE_SAND_ATTACK, MOVE_POISON_STING, MOVE_DEFENSE_CURL},
    },
    {
        .iv = 24,
        .lvl = 11,
        .species = SPECIES_DIGLETT,
        .moves = {MOVE_SCRATCH, MOVE_GROWL, MOVE_ASTONISH, MOVE_MUD_SLAP},
    },
};
...
static const struct TrainerMonNoItemCustomMoves sParty_PrimalColby[] = {
    {
        ...
        .moves = {MOVE_SURF, MOVE_WISH, MOVE_PROTECT, MOVE_ICE_BEAM},
    },
    {
        .iv = 31,
        .lvl = 56,
        .species = SPECIES_ALAKAZAM,
        .moves = {MOVE_PSYCHIC, MOVE_BRICK_BREAK, MOVE_SHADOW_BALL, MOVE_CALM_MIND},
    },
    {
        .iv = 31,
        .lvl = 58,
    ...
    },
    {
        ...
        .moves = {MOVE_EARTHQUAKE, MOVE_SLUDGE_BOMB, MOVE_ICE_BEAM, MOVE_FLAMETHROWER},
    },
    {
        .iv = 31,
        .lvl = 65,
...
static const struct TrainerMonNoItemCustomMoves sParty_PrimalTyler[] = {
    {
        ...
        .moves = {MOVE_FIRE_BLAST, MOVE_EXTREME_SPEED, MOVE_THUNDERBOLT, MOVE_MORNING_SUN},
    },
    {
        .iv = 31,
        .lvl = 56,
    ...
    },
    {
        ...
        .lvl = 58,
        .species = SPECIES_MACHAMP,
        .moves = {MOVE_DYNAMIC_PUNCH, MOVE_BULK_UP, MOVE_KNOCK_OFF, MOVE_METAL_CLAW},
    },
    {
        .iv = 31,
        .lvl = 60,
    ...
    },
    {
        ...
        .moves = {MOVE_DRAGON_DANCE, MOVE_OUTRAGE, MOVE_FIRE_PUNCH, MOVE_REST},
    },
};
...
static const struct TrainerMonNoItemCustomMoves sParty_PrimalLaithan[] = {
    {
        ...
        .moves = {MOVE_HYPER_VOICE, MOVE_KNOCK_OFF, MOVE_TAUNT, MOVE_BATON_PASS},
    },
    {
        .iv = 31,
        .lvl = 56,
        .species = SPECIES_RAPIDASH,
        .moves = {MOVE_FIRE_BLAST, MOVE_THUNDERBOLT, MOVE_MORNING_SUN, MOVE_WILL_O_WISP},
    },
    {
        .iv = 31,
        .lvl = 58,
        .species = SPECIES_CLOYSTER,
        .moves = {MOVE_SPIKES, MOVE_ICICLE_SPEAR, MOVE_ROCK_BLAST, MOVE_ICE_BEAM},
    },
    {
        .iv = 31,
        .lvl = 60,
        .species = SPECIES_TENTACRUEL,
        .moves = {MOVE_SURF, MOVE_RAPID_SPIN, MOVE_TOXIC, MOVE_HAZE},
    },
    {
        .iv = 31,
        .lvl = 62,
        .species = SPECIES_PARASECT,
        .moves = {MOVE_SPORE, MOVE_LEECH_SEED, MOVE_SLASH, MOVE_STUN_SPORE},
    },
    {
        .iv = 31,
        .lvl = 65,
        .species = SPECIES_SANDSLASH,
        .moves = {MOVE_EARTHQUAKE, MOVE_SWORDS_DANCE, MOVE_ROCK_SLIDE, MOVE_KNOCK_OFF},
    },
};
...
static const struct TrainerMonNoItemCustomMoves sParty_PrimalDillon[] = {
    {
        ...
        .lvl = 55,
        .species = SPECIES_SQUIRTLE,
        .moves = {MOVE_SURF, MOVE_TOXIC, MOVE_PROTECT, MOVE_RAPID_SPIN},
    },
    {
        .iv = 31,
        .lvl = 56,
        .species = SPECIES_EKANS,
        .moves = {MOVE_GLARE, MOVE_SWORDS_DANCE, MOVE_CRUNCH, MOVE_SLUDGE_BOMB},
    },
    {
        .iv = 31,
        .lvl = 58,
        .species = SPECIES_JOLTEON,
        .moves = {MOVE_THUNDERBOLT, MOVE_DOUBLE_KICK, MOVE_SHADOW_BALL, MOVE_GROWTH},
    },
    {
        .iv = 31,
        .lvl = 60,
        .species = SPECIES_PRIMEAPE,
        .moves = {MOVE_CROSS_CHOP, MOVE_BATON_PASS, MOVE_ROCK_SLIDE, MOVE_SLUDGE_BOMB},
    },
    {
        .iv = 31,
        .lvl = 62,
        .species = SPECIES_GYARADOS,
        .moves = {MOVE_DRAGON_DANCE, MOVE_WATERFALL, MOVE_BITE, MOVE_EARTHQUAKE},
    },
    {
        .iv = 31,
        .lvl = 65,
        .species = SPECIES_CHARIZARD,
        .moves = {MOVE_FLAMETHROWER, MOVE_WING_ATTACK, MOVE_DRAGON_CLAW, MOVE_REST},
    },
};
...
static const struct TrainerMonNoItemCustomMoves sParty_LeaderGiovanni[] = {
    ...
    },
    {
        ...
        .lvl = 46,
        .species = SPECIES_NIDOKING,
        .moves = {MOVE_EARTHQUAKE, MOVE_FLAMETHROWER, MOVE_ICE_BEAM, MOVE_THUNDERBOLT}, // Coverage king
    },
    {
        .iv = 31,
        .lvl = 46,
        .species = SPECIES_PORYGON,
        .moves = {MOVE_THUNDERBOLT, MOVE_PSYCHIC, MOVE_RECOVER, MOVE_ICE_BEAM},
    },
    {
        .iv = 31,
        .lvl = 47,
        .species = SPECIES_EXEGGUTOR,
        .moves = {MOVE_PSYCHIC, MOVE_GIGA_DRAIN, MOVE_STUN_SPORE, MOVE_SLEEP_POWDER},
    },
    {
        .iv = 31,
        .lvl = 50,
        .species = SPECIES_RHYDON,
        .moves = {MOVE_EARTHQUAKE, MOVE_ROCK_SLIDE, MOVE_MEGAHORN, MOVE_SCARY_FACE},
    },
};
...
static const struct TrainerMonNoItemCustomMoves sParty_LeaderBrock[] = {
    {
        ...
        .lvl = 12,
        .species = SPECIES_GEODUDE,
        .moves = {MOVE_ROCK_THROW, MOVE_MUD_SLAP, MOVE_DEFENSE_CURL, MOVE_ROLLOUT},
    },
    {
        .iv = 31,
        .lvl = 13,
        .species = SPECIES_VOLTORB,
        .moves = {MOVE_THUNDER_SHOCK, MOVE_CHARGE, MOVE_TACKLE, MOVE_SONIC_BOOM},
    },
    {
        .iv = 31,
        .lvl = 13,
        .species = SPECIES_VULPIX,
        .moves = {MOVE_EMBER, MOVE_QUICK_ATTACK, MOVE_WILL_O_WISP, MOVE_ROAR},
    },
    {
        .iv = 31,
        .lvl = 14,
        .species = SPECIES_RHYHORN,
        .moves = {MOVE_HORN_ATTACK, MOVE_TAIL_WHIP, MOVE_SCARY_FACE, MOVE_ROCK_TOMB},
    },
    {
        .iv = 31,
        .lvl = 15,
        .species = SPECIES_ONIX,
        .moves = {MOVE_ROCK_TOMB, MOVE_BIND, MOVE_SCREECH, MOVE_SANDSTORM},
    },
};
...
static const struct TrainerMonNoItemCustomMoves sParty_BugCatcherCharlie[] = {
    {
        ...
        .lvl = 9,
        .species = SPECIES_BUTTERFREE,
        .moves = {MOVE_CONFUSION, MOVE_SUPERSONIC, MOVE_STRING_SHOT, MOVE_NONE},
    },
    {
        .iv = 31,
        .lvl = 8,
    ...
    },
    {
        ...
        .lvl = 8,
        .species = SPECIES_VENONAT,
        .moves = {MOVE_SUPERSONIC, MOVE_DISABLE, MOVE_POISON_POWDER, MOVE_TACKLE},
    },
};
